...
namespace sdds {
	...
	std::ostream& operator<<(std::ostream& os, const Book& b) {
		return os << std::setw(20) << b.author << " |" << std::right << std::setw(23) << b.name << " |" << std::setw(6) << b.country_published << " |" << std::setw(5) << b.year_published << " |" << std::setw(6) << std::setprecision(2) << std::fixed << b.cost << " | " << b.description << "\n";
	}
